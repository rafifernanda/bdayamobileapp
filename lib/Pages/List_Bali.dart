...
class List_Bali extends StatefulWidget {
  @override
  _List_BaliState createState() => _List_BaliState();
}

class _List_BaliState extends State<List_Bali> {
  Map data;
  List userData;
  List list;
...
//  }
  Future getData() async {
    http.Response response = await http.get(
        "http://127.0.0.1:8080/apibdaya/api/bali"); //"http://lifei.id/api/bali/transaksi");
    data = json.decode(response.body);
    setState(() {
      userData = data["data"];
    });
